-- ============================================
-- Modern Chat System - Database Setup (DEMO COMPATIBLE)
-- Run THIS for demo/development mode compatibility
-- ============================================
...
-- ============================================
-- 2. CONVERSATION MEMBERS TABLE (Modified for demo compatibility)
-- ============================================
...
-- ============================================
-- 3. MESSAGES TABLE (Modified for demo compatibility)
-- ============================================

CREATE TABLE messages (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  conversation_id UUID NOT NULL REFERENCES conversations(id) ON DELETE CASCADE,
  sender_id UUID NOT NULL, -- Removed FK constraint for demo compatibility
...
-- ============================================
-- 4. MESSAGE REACTIONS TABLE (Modified for demo compatibility)
-- ============================================
...
-- ============================================
-- 5. MESSAGE READS TABLE (Read Receipts) (Modified for demo compatibility)
-- ============================================
...
SELECT '✅ Modern chat tables created successfully (DEMO COMPATIBLE)!' AS status;

-- ============================================
-- NOTES
-- ============================================
-- This version removes foreign key constraints to auth.users
-- to allow demo/mock users that don't exist in auth.users table.
--
-- For production, you may want to restore the FK constraints:
