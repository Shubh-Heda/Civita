...
import { Search, Filter, Users, Heart, Sparkles, User, MessageCircle, Calendar, TrendingUp, Star, MapPin, Shield, Music, HelpCircle, Ticket, Clock, Map, Trophy, Camera, Video } from 'lucide-react';
