          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                <h3 className="font-bold text-slate-100 group-hover:text-purple-300 transition-colors">Discover Parties</h3>
                <p className="text-sm text-slate-400">Browse all party events near you</p>
              </div>
            </div>
          </div>
        </motion.button>
